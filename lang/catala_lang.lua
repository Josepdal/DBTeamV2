...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		-- moderation.lua --
		set_text(LANG, 'kickUser', '`>` L\'usuari `$id` ha estat *expulsat.*')
		set_text(LANG, 'banUser', '`>` L\'usuari `$id` ha estat *bannejat.*')
		set_text(LANG, 'unbanUser', '`>` L\'usuari `$id` ha estat *eliminat* de la llista de *bannejats.*')
		set_text(LANG, 'gbanUser', '`>` L\'usuari `$id` ha estat *globalment bannejat*.')
		set_text(LANG, 'ungbanUser', '`>` L\'usuari `$id` ha estat *eliminat* de la *llista de bannejats globalment.*')
		set_text(LANG, 'muteUser', '`>` L\'usuari `$id` ha estat *sil·lenciat.*')
		set_text(LANG, 'muteChat', '`>` El grup ha estat *sil·lenciat.*')
		set_text(LANG, 'muteChatSec', '`>` El chat ha estat *sil·lenciat* durant ')
		set_text(LANG, 'muteUserSec', '`>` L\'usuari `$id` ha estat *sil·lenciat* per ')
		set_text(LANG, 'unmuteUser', '`>` L\'usuari `$id` *pot parlar ara.*')
