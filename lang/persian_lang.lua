...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		set_text(LANG, 'id:3', '#id <user_name>: دريافت شناسه با استفاده از نام کاربري.')
		set_text(LANG, 'id:4', '#whois <user_id>/<user_name>: دريافت نام کاربري با استفاده از شناسه.')
		set_text(LANG, 'id:5', '#whois (reply): دريافت شناسه با استفاده از ريپلي.')
		-- moderation.lua --
