...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		-- moderation.lua --
		set_text(LANG, 'kickUser', '`>` The user `$id` has been *kicked out.*')
		set_text(LANG, 'banUser', '`>` The user `$id` has been *banned.*')
		set_text(LANG, 'unbanUser', '`>` The user `$id` has been *removed* from *ban list.*')
		set_text(LANG, 'gbanUser', '`>` The user `$id` has been *globally banned*.')
		set_text(LANG, 'ungbanUser', '`>` The user `$id` has been *removed* from *global ban list.*')
		set_text(LANG, 'muteUser', '`>` The user `$id` has been *muted.*')
		set_text(LANG, 'muteChat', '`>` The chat has been *muted.*')
		set_text(LANG, 'muteChatSec', '`>` The chat has been *muted* for ')
		set_text(LANG, 'muteUserSec', '`>` The user `$id` has been *muted* for ')
		set_text(LANG, 'unmuteUser', '`>` The user `$id` *can talk now.*')
