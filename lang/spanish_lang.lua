...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		set_text(LANG, 'userID', '*ID del usuario:*')
		set_text(LANG, 'chatID', '*ID del chat:*')

		-- moderation.lua --
		set_text(LANG, 'kickUser', '`>` El usuario `$id` ha sido *expulsado.*')
		set_text(LANG, 'banUser', '`>` El usuario `$id` ha sido *baneado.*')
		set_text(LANG, 'unbanUser', '`>` El usuario `$id` ha sido *borrado* de la lista *baneados.*')
		set_text(LANG, 'gbanUser', '`>` EL usuario `$id` ha sido *baneado globalmente*.')
		set_text(LANG, 'ungbanUser', '`>` El usuario `$id` ha sido *borrado* de la *lista de baneados globales. *')
		set_text(LANG, 'muteUser', '`>` El usuario `$id` ha sido *silenciado.*')
		set_text(LANG, 'muteChat', '`>` El chat ha sido *silenciado.*')
		set_text(LANG, 'muteChatSec', '`>` EL chat ha sido *silenciado* durante ')
		set_text(LANG, 'muteUserSec', '`>` El usuario `$id` ha sido *silenciado* durante ')
		set_text(LANG, 'unmuteUser', '`>` El usuario `$id` *puede hablar ahora.*')
