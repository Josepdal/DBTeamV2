...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		set_text(LANG, 'versionExtended', 'Versión de la traducción 1.1')
		...
		set_text(LANG, 'arabicT', '`>` El *árabe* *permitido* en este chat.')
		set_text(LANG, 'noArabicT', '`>` El *árabe* *no permitido* en este chat.')
		...
		set_text(LANG, 'noLocationT', '`>`  *Ubicación* *no permitida* en este chat.')
		...
		set_text(LANG, 'inviteT', '`>` *Invitación* *permitida* en este chat.')
		set_text(LANG, 'noInviteT', '`>`  *Invitación* *no permitida* en este chat.')

		set_text(LANG, 'voiceT', '`>` *Notas de voz* están *permitida* en este chat.')
		set_text(LANG, 'noVoiceT', '`>`  *Notas de voz* *no está permitida* en este chat.')
		...
		set_text(LANG, 'gbanUser', '`>` El usuario ha sido *globalmente baneado*.')
	...
	--	set_text(LANG, 'gban_installer:1', '#install gbans: añade una lista de gbans en tu base de datos redis.')
		...
		set_text(LANG, 'promote:5', '#user (reply): Eliminar admininistrador por respuesta.')
		set_text(LANG, 'promote:6', '#user <user_id>/<user_name>: Añade un moderador mediante su ID/Username.')		
	    ...
	    -- set_text(LANG, 'settings:5', '#bots on/off: Cuando está inhabilitado, si alguien añade un bot, se eliminara.')
